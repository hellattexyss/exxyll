if game.PlaceId == 10449761463 or game.PlaceId == 130818724007978 or game.PlaceId == 131048399685555 then
    ...
    local Window = WindUI:CreateWindow({
        Title = "Waspire Combat UI",
        Author = "The Strongest Battlegrounds",
        Folder = "WaspireCombatUI",
        Icon = "shield",
        IconThemed = true,
    ...
    Window:Tag({
        ...
        BorderColor = Color3.fromRGB(220, 20, 60),
    })
    ...
    Window:TopbarButton({
        ...
        Callback = function()
            if setclipboard then
                pcall(function()
                    setclipboard("https://www.youtube.com/@waspire")
                end)
            end
            WindUI:Notify({
                Title = "YouTube Channel",
                Content = "Link copied to clipboard! Please Subscribe!",
                Icon = "youtube",
                Duration = 3
            })
        end
    ...
    Window:TopbarButton({
        ...
        Callback = function()
            if setclipboard then
                pcall(function()
                    setclipboard("https://discord.gg/HGpNBG4TAD")
                end)
            end
            WindUI:Notify({
                Title = "Discord Server",
                Content = "Link copied to clipboard! Join for help/assistance!",
                Icon = "message-circle",
                Duration = 3
            })
        end
    ...
    -- Sidebar buttons for quick actions
    ...
    HomeTab:Paragraph({
        ...
        Desc = "Waspire Combat UI v1.0 - The Strongest Battlegrounds\n\nThis script provides advanced combat features including Auto Block, Camlock, ESP systems, and more.\n\nStatus: Working ✓",
        Buttons = {
            {
                Title = "Join Discord",
                Icon = "message-circle",
    ...
    local stats = HomeTab:Stats({
        Title = "Server Statistics",
        Desc = "Live server information",
        Items = {
            {Key = "Members", Value = "32,100"},
            {Key = "Online", Value = "4,000"},
            {Key = "Subscribers", Value = "26,000"},
    ...
    local creditsGroup = HomeTab:Group({})
    ...
    local m1RangeSlider = CombatTab:Slider({
        ...
        Callback = function(value)
            ...
            WindUI:Notify({
                Title = "Settings Updated",
                Content = "M1 range set to " .. value .. " studs",
                Duration = 1.5,
                Icon = "settings"
            })
        end
    ...
    local keybindInput = CamlockTab:Keybind({
        ...
        Value = ConfigManager:Get("CamlockKeybind").Key,
        Callback = function(v)
            local newKeybind = {
                Key = v,
                Type = "Keyboard"
    ...
    CamlockTab:Section({
        ...
        Desc = "Additional camlock configuration",
        Icon = "settings"
    })
    ...
    local blockAimSmoothness = CamlockTab:Slider({
        ...
        Value = {
            Min = 0.1,
            Max = 1.0,
            Default = ConfigManager:Get("BlockAimSmoothness") or 0.5,
        },
        IsTextbox = true,
        Callback = function(value)
    ...
    ESPTab:Section({
        Title = "ESP Systems",
        Desc = "Visual indicators and warnings",
        Icon = "eye"
    })
    ...
    local toxicMessageInput = UtilityTab:Input({
        ...
        Value = ConfigManager:Get("AutoToxicMessage"),
...
loadDefaultsFunction = function()
    ...
    OthersTab:Section({
        ...
        Desc = "Features in development",
        Icon = "clock"
    })
    
    local comingSoon = OthersTab:Group({})
    comingSoon:Paragraph({
        Title = "Side Dash Assist",
        Desc = "Coming soon - Automated side dash mechanics"
    })
    comingSoon:Paragraph({
        Title = "Instant Lethal Dash",
        Desc = "Coming soon - Quick dash attacks"
    })
    comingSoon:Paragraph({
        Title = "Loopdash",
        Desc = "Coming soon - Continuous dash combos"
    })
    comingSoon:Paragraph({
        Title = "Wasp Dash",
        Desc = "Coming soon - Unique dash technique"
    })
    comingSoon:Paragraph({
        Title = "Instant Twisted",
        Desc = "Coming soon - Quick twist mechanics"
    })
    comingSoon:Paragraph({
        Title = "50+ Movesets",
        Desc = "Coming soon - Extensive move library"
    })
    comingSoon:Paragraph({
        Title = "30+ Techs",
        Desc = "Coming soon - Advanced techniques"
    })
    ...
    OthersTab:Button({
        ...
        Desc = "Join our Discord for help and early access",
        Icon = "message-circle",
        Callback = function()
            setclipboard("https://discord.gg/HGpNBG4TAD")
            WindUI:Notify({
    ...
    function BlockAim:Toggle()
        if self.Enabled then
            ...
            ConfigManager:Set("BlockAimEnabled", true)
            self:Start()
            return true
        end
    end
    ...
    function HighPingWarning:StartBlinking()
        ...
        self.BlinkConnection = RunService.Heartbeat:Connect(function()
            ...
            local alpha = 0.3 + (math.sin(tick() * 5) * 0.2)
